  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at [Link to Adobe Flash Player Help]</li>
        <li><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
      </ul>
      <p className="mb-4">Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Cookies: What Do They Do?</a></p>
      ...
      <h3 className="text-xl font-bold mb-2">Sharing Your Personal Data</h3>
      ...
      <h2 className="text-2xl font-bold mb-3">Retention of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mb-3">Transfer of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mb-3">Delete Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mb-3">Disclosure of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mb-3">Security of Your Personal Data</h2>

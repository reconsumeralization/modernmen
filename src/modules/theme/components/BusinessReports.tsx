...
const BusinessReports: React.FC<BusinessReportsProps> = ({ dateRange }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          <Select
            value={{ label: reportType === 'overview' ? 'Overview' : 'Revenue', value: reportType }}
            onChange={(option) => setReportType(option?.value || 'overview')}
            options={[
